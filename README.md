...
> Worflow [worflows/Suspicious_DNS_Activity_Email.yml](worflows/Suspicious_DNS_Activity_Email.yml) config `multi_instance` is `true`. It allows creation of multiple instance of a workflow for the same customer. 
